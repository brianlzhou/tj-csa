...
public class IteratorLab
{
   ...
   {
      ListIterator<Integer> li = a.listIterator();  //works
	   while( li.hasNext() )
		if( li.next() < 0)
			li.set(0);   //no arguments in this method!
   ...
   public static void deleteZero(ArrayList<Integer> a)
   {
      ListIterator<Integer> li = a.listIterator();  //works
	   while( li.hasNext() )
		if( li.next() == 0)
			li.remove();   //no arguments in this method!
   }
   ...
   {
      ArrayList<String> myList = new ArrayList<String>();
      ListIterator<String> li = a.listIterator();  //works
	   while( li.hasNext() ) {
         if(!myList.contains(li.next())) {
