...
public class LunchRoom
{
   ...
   public static void lunchRoom(int TIME, PrintWriter outfile)
   {
      ...
      *************************/
      ...
      for(int i = 0; i<= TIME; i++) {
         if(Math.random()*5 <= 1) {
            double tempClass = Math.random()*4;
            if(tempClass <= 1) {
               q.add(new Customer(i, timeToOrderAndBeServed(), 2022));
               arr[0][0]++;
            }
            else if(tempClass <= 2) {
               q.add(new Customer(i, timeToOrderAndBeServed(), 2023));
               arr[1][0]++;
            }
            else if(tempClass <= 3) {
               q.add(new Customer(i, timeToOrderAndBeServed(), 2024));
               arr[2][0]++;
            }
            else if(tempClass <= 4) {
               q.add(new Customer(i, timeToOrderAndBeServed(), 2025));
               arr[3][0]++;
            }
         }
         if(!q.isEmpty()){
            ...
            if(timeLeft == 0) {
               ...
               int arrYr = removed.getYear()-2022;
               arr[arrYr][2] = arr[arrYr][2] + waitTime;
               if(waitTime > arr[arrYr][1]) {
                  arr[arrYr][1] = waitTime;
               }
            }
            else{
               //System.out.println(i + ": " + q);
               displayTimeAndQueue(i, q);
      ...
      System.out.println("Senior\t\t" + arr[0][0] + "\t\t\t" + arr[0][1] + "\t\t\t" + (double) arr[0][2]/arr[0][0]);
      System.out.println("Junior\t\t" + arr[1][0] + "\t\t\t" + arr[1][1] + "\t\t\t" + (double) arr[1][2]/arr[1][0]);
      System.out.println("Sophomor\t\t" + arr[2][0] + "\t\t\t" + arr[2][1] + "\t\t\t" + (double) arr[2][2]/arr[2][0]);
      System.out.println("Freshman\t\t" + arr[3][0] + "\t\t\t" + arr[3][1] + "\t\t\t" + (double) arr[3][2]/arr[3][0]);
   ...
   public static class Customer implements Comparable<Customer>
   {
      ...
      ***********************************/
      ...
      public Customer(int time, int ordertime, int year) {
         arrivedAt = time;
      ...
      public String toString() {
         return String.valueOf(this.arrivedAt) + ":" + this.getStringYear();
      }
      public int compareTo(Customer e) {
         return this.gradYr-e.gradYr;
