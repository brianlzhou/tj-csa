...
public class Infix_Extension
{
   ...
   public static final String notOperators = "@ # $ & \\ | ` ~ ? ; : \" \'";
   ...
   public static String infixToPostfix(String infix) throws Exception
   {
      ...
      List<String> checkSymbols = new ArrayList<String>(Arrays.asList(infix.split(" ")));
      Iterator<String> symbIt = checkSymbols.iterator();
      while(symbIt.hasNext()) {
         String temp = symbIt.next();
         if (notOperators.indexOf(temp) != -1) {
